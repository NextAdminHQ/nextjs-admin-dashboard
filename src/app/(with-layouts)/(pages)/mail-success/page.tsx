    ...
    <div className="mt-6 space-y-5">
      ...
      <div className="px-2 lg:px-6">
        <div className="flex flex-col-reverse items-start justify-between gap-3 sm:flex-row sm:items-center">
          <h1 className="mb-1 text-[28px] leading-8 font-medium text-text-primary">Mail Success</h1>
          <div>
            <Breadcrumbs
              dividerType="chevron"
              items={[
                { href: "/", label: "Home" },
                { href: "#", label: "Pages" },
                { href: "/mail-success", label: "Mail Success" },
              ]}
            />
          </div>
        </div>
            ...
            <div className="relative flex w-full flex-col items-center justify-center pt-10 pb-20">
              ...
              <div className="mt-20 flex max-w-140 flex-col items-center gap-3 text-center">
                ...
                <div className="text-sm leading-5 font-normal tracking-[-0.15px] text-balance text-text-tertiary">
                  <p>
                    Thank you so much for your message. We check e-mail frequently and will try our
