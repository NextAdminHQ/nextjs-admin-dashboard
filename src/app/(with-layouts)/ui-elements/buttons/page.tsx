import ButtonOutlinedPreview from "@/app/(with-layouts)/ui-elements/buttons/_components/button-outlined";
import ButtonSizesPreview from "@/app/(with-layouts)/ui-elements/buttons/_components/button-sizes";
import ButtonTypesPreview from "@/app/(with-layouts)/ui-elements/buttons/_components/button-types";
  ...
  return (
    <section className="mt-6 space-y-5">
      ...
      <div className="flex flex-col-reverse justify-between gap-3 px-2 md:flex-row md:items-center lg:px-6">
        <h1 className="mb-1 text-[28px] leading-8 font-medium text-text-primary">Buttons</h1>
