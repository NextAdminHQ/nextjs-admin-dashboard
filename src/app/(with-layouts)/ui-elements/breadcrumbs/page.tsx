import BreadcrumbArrow from "@/app/(with-layouts)/ui-elements/breadcrumbs/_components/breadcrumb-arrow";
import BreadcrumbSlash from "@/app/(with-layouts)/ui-elements/breadcrumbs/_components/breadcrumb-slash";
  ...
  return (
    <section className="mt-6 space-y-5">
      ...
      <div className="flex flex-col-reverse justify-between gap-3 px-2 md:flex-row md:items-center lg:px-6">
        <h1 className="mb-1 text-[28px] leading-8 font-medium text-text-primary">Breadcrumbs</h1>
        ...
        <Breadcrumbs
          ...
          items={[
            ...
            { href: "/ui-elements/breadcrumbs", label: "Breadcrumbs" },
          ]}
        />
      </div>
